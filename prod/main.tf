...
resource "aws_iam_role" "prod_mc_instance_role" {
  name = "prod-mc-instance-role"
...
resource "aws_iam_role_policy" "prod_mc_instance_policy" {
  role = aws_iam_role.prod_mc_instance_role.id
...
resource "aws_iam_instance_profile" "prod_mc_instance" {
  name = "mc-instance-profile"
  role = aws_iam_role.prod_mc_instance_role.name
}
...
resource "aws_instance" "prod_mc_server" {
  ...
  iam_instance_profile = aws_iam_instance_profile.prod_mc_instance.name
...
resource "aws_sns_topic" "prod_liam_alarm_notifications" {
  name = "prod-liam-alarm-notifications"
}

resource "aws_sns_topic_subscription" "email" {
  topic_arn = aws_sns_topic.prod_liam_alarm_notifications.arn
  protocol  = "email"
...
resource "aws_cloudwatch_metric_alarm" "prod_instance_is_active_long" {
  alarm_name          = "ProdInstanceIsActiveLong"
